          ...
          >
            <div layout="vertical">
              <div className="header-top">
                <Title level={4}>
                  Configurations
                  <Text className="subtitle">Voir les options du tableau de bord</Text>
                </Title>
              </div>

              <div className="sidebar-color">
                <Title level={5}>Couleur du Menu</Title>
                ...
                <div className="sidebarnav-color mb-2">
                  ...
                  <Text>Choisissez parmi les deux types de menu.</Text>
                ...
                <div className="fixed-nav mb-2">
                  <Title level={5}>Fixer la barre de navigation</Title>
